...
function TermsConditionsScreen() {
  ...
  <h2 className="text-2xl italic font-bold mb-4 text-pink-500">Fraud Prevention Measures:</h2>
  ...
  <h2 className="text-2xl italic font-bold mb-4 mt-8 text-pink-500">Prohibited Activities:</h2>
  <ul className="list-disc pl-6 text-white">
  ...
  <h2 className="text-2xl italic font-bold mb-4 mt-8 text-pink-500">User Responsibilities:</h2>
  <ul className="list-disc pl-6 text-white">
  ...
  <h2 className="text-2xl italic font-bold mb-4 mt-8 text-pink-500">Verification Process:</h2>
  <ul className="list-disc pl-6 text-white">
  ...
  <h2 className="text-2xl italic font-bold mb-4 mt-8 text-pink-500">Limitation of Liability:</h2>
  <ul className="list-disc pl-6 text-white">
  ...
  <h2 className="text-2xl italic font-bold mb-4 mt-8 text-pink-500">Intellectual Property Rights:</h2>
  <ul className="list-disc pl-6 text-white">
  ...
  <h2 className="text-2xl italic font-bold mb-4 mt-8 text-pink-500">Platform Cost:</h2>
  <ul className="list-disc pl-6 text-white">
