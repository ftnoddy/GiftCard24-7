      ...
      <div className="h-screen w-screen bg-gradient-to-t from-red-700 via-rose-600 to-pink-500 min-h-screen flex items-center justify-center">
        <div className="bg-white bg-opacity-25 rounded-lg p-8 backdrop-blur-lg shadow-xl w-full max-w-4xl mx-auto">
          ...
          <p className="text-lg text-white mb-8">
            As an extension of iWebGenics, GiftCards247.shop ensures a seamless shopping experience for customers worldwide. Leveraging the expertise of iWebGenics, GiftCards247.shop delivers unparalleled value to its clientele. We offer e-gift cards from a wide range of brands from across the globe, allowing you to shop for your favorite goodies and merchandise without any hassle.
          </p>
          <p className="text-lg text-white mb-8">
